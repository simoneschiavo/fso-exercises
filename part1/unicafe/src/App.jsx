...
const Statistics = (props) => {
  return (
    <>
      ...
      <StatisticLine text="average" statistic={Math.round((props.value / props.all) * 100) / 100} />
      <StatisticLine text="positive" statistic={Math.round((props.good / props.all) * 10000) / 100 + "%"} />
    </>
  );
}
